...
public class RecordTimeTable_Helper extends SQLiteOpenHelper {
    ...
    private final String db_table_name4 = "sessionTABLE";
    ...
    public void add(int id, String a, String b,String c,String d,int e,
                    String mon,String tues,String wednes,String thurs,String fri){
...
//                "where "+getDay()+" like 'true';";
    ...
    public void insertID(String session_id, String session_pw ){
        ContentValues val = new ContentValues();
        val.put("session_id", session_id);
        val.put("session_pw",session_pw);
        db.insert(db_table_name4, null, val);
        Log.v("AhReum", "id : " + session_id);
    }
