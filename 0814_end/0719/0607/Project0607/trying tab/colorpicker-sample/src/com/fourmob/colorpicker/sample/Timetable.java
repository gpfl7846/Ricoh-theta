...
public class Timetable extends Activity implements OnClickListener {
    ...
    String db_classroom, db_subject, db_starttime, db_endtime, db_mon, db_tues, db_wednes, db_thus, db_fri;
    ...
    private ServiceConnection playerServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName arg0, IBinder service) {
            DBAdapter.PlayerService.PlayerBinder playerBinder = (DBAdapter.PlayerService.PlayerBinder)service;
                ...
                if ((cur != null) && (!cur.isAfterLast())) {
                    ...
                    if (inputdata[id].getId() == db_id) {
                        ...
                        helper.update(db_id, db_subject, db_classroom, db_starttime, db_endtime,
                                db_background, db_mon, db_tues, db_wednes, db_thus, db_fri);
                        cur.moveToNext();
                    }
                ...
                if (clicked.equals("true")) {
                    ...
                    if (week[(get_id % 5)].equals("true")) {
                        ...
                        helper.add(get_id, subject, classroom, starttime1, endtime1, colorpicker,
                                monday_boolean, tuesday_boolean, wednesday_boolean, thursday_boolean, friday_boolean);
            ...
            //데이터가 있는 곳에서 수정을 할 경우
                ...
                if (clicked.equals("true")) {
                    ...
                    helper.update(get_id, subject, classroom, starttimechange, endtimechange, colorpicker,
                            monday_check, tuesday_check, wednesday_check, thursday_check, friday_check);
