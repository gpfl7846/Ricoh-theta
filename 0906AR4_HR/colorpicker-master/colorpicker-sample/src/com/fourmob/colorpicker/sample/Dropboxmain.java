...
public class Dropboxmain extends Activity implements OnClickListener {
    ...
    private final static String ACCESS_KEY = "crw6v7mz5anvh8o";
    private final static String ACCESS_SECRET = "acpgwtl1p1cedhr";
    ...
    public class DropboxUploadFile extends AsyncTask<Void, Long, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            if (result) {
                ...
                Toast.makeText(context, "업로드 할 녹음 파일이 없습니다.수업 녹음을 시작해보세요!",
                        Toast.LENGTH_LONG).show();
            }
        }
